...
const standards = [
  ...
  { label: "Head height", value: "32-36 mm (70-80% of frame)" },
  ...
  { label: "Printed on", value: "10 x 15 cm (4 x 6 inch) photo paper" },
  ...
  return (
    <Sheet>
      ...
      <SheetContent className="w-[320px] sm:w-[380px] overflow-y-auto">
        <SheetHeader>
          <SheetTitle className="text-base">AU Passport Photo Standards</SheetTitle>
        </SheetHeader>
